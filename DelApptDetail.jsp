...
<p align="right"><b><a href="ApptDetails.jsp">View Appointment</a></b></p>
<div align="center">
  <center>
  <%
		try 
		{
			...
			PreparedStatement pst = con.prepareStatement("SELECT apid, CSName, apdate, time FROM appt where agno=?");
			pst.setString(1, ano);
			ResultSet rs = pst.executeQuery();
  %>
 <form method="POST" action="DelAppt.jsp">
  <table border="0" cellpadding="0" cellspacing="0" width="676" id="AutoNumber1" style="border-left-style: none; border-right-style: none; border-top-style: none; border-bottom: 1.5pt solid black; background-color: silver; border-collapse:collapse" fpstyle="9,011111000" bordercolor="#111111" height="78">
    <tr class="thead">
      ...
      <td width="231" height="21">Customer Name</td>
      <td width="226" height="21">Date</td>
      <td width="148" height="21">Time</td>
    </tr>
    <tr>
      <td width="71" style="color: black; border-style: none; background-color: #FFFFEF" height="19">&nbsp;</td>
    ...
    %>
    <tr>
      <td width="71" style="color: black; border-style: none; background-color: #FFFFEF" height="19">
        <input type="radio" value="<%= apid%>" checked name="apid"></td>
      <td width="231" style="color: black; border-style: none; background-color: #FFFFEF" height="19">&nbsp;<%= rs.getString(2) %></td>
      <td width="226" style="color: black; border-style: none; background-color: #FFFFEF" height="19">&nbsp;<%= rs.getString(3) %></td>
      <td width="148" style="color: black; border-style: none; background-color: #FFFFEF" height="19">&nbsp;<%= rs.getString(4) %></td>
    </tr>
    <%
    	}
    	if(!found)
    ...
    <tr>
      ...
      <td width="605" style="color: black; border-style: none; background-color: #FFFFEF" colspan="3" height="19">
      <p align="center"><input type="submit" value="Delete" name="B1"></td>
    </tr>
    <tr>
      <td width="71" style="color: black; border-style: none; background-color: #FFFFEF" height="19">&nbsp;
      </td>
