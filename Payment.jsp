  ...
  %>
   ...
   <table border="0" cellpadding="0" cellspacing="0" style="border-bottom:1.5pt solid black; border-collapse: collapse; border-left-style:none; border-right-style:none; border-top-style:none; background-color:silver" bordercolor="#111111" width="70%" id="AutoNumber2" fpstyle="9,011111000" height="133">
     ...
     <tr>
       ...
       <a href="AddPolicy.jsp?cno=<%=cno%>">Add Policy</a> | <a href="PayReport.jsp?cno=<%=cno%>">Payment Report</a></td>
     </tr>
     <%
     	}
     %>
   ...
   %>
   <table border="0" cellpadding="0" cellspacing="0" style="border-bottom:1.5pt solid black; border-collapse: collapse; border-left-style:none; border-right-style:none; border-top-style:none; background-color:silver" bordercolor="#111111" width="578" id="AutoNumber3" fpstyle="9,011111000" height="86">
     <tr>
       <td width="578" style="font-weight: bold; color: white; border-left-style: none; border-right-style: none; border-top-style: none; border-bottom: 1.5pt solid black; background-color: maroon" align="left" height="1" colspan="7">&nbsp;Policy Details</td>
     </tr>
     <tr>
       <td width="25" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center"></td>
       <td width="113" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <p style="margin-left: 15"><b>Policy No</b></td>
       <td width="60" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <b>Date</b></td>
       <td width="180" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <b>No of Years</b></td>
       <td width="67" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <b>Policy Amount</b></td>
       <td width="60" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <b>Mode</b></td>
       <td width="73" style="color: black; border-style: none; background-color: #FFFFEF" height="20" align="center">
       <b>Premium</b></td>
     </tr>
     ...
     %>
     <tr>
       <td width="25" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
         <input type="radio" value="<%=policyid%>" checked name="policyid"></p>
       </td>
       <td width="113" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <p style="margin-left: 15"><%=policyid%></td>
       <td width="60" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <%=rspd.getString(3)%></td>
       <td width="180" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <%=rspd.getString(4)%></td>
       <td width="67" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <%=rspd.getString(5)%></td>
       <td width="60" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <%=rspd.getString(6)%></td>
       <td width="73" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">
       <%=rspd.getString(7)%></td>
     </tr>
     <%
     	}
     %>
     <tr>
       <td width="25" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center">&nbsp;       </td>
       <td width="553" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center" colspan="6">&nbsp;       </td>
     </tr>
     <tr>
       <td width="578" style="color: black; background-color: #FFFFEF; border-style: none" height="21" align="center" colspan="7">
       <input type="submit" value="Make Payment" name="B1"></td>
     </tr>
     </form>
     <tr>
       <td width="578" style="color: black; border-style: none; background-color: #FFFFEF" height="21" align="center" colspan="7">&nbsp;
       </td>
     </tr>
     </table>
   <%
