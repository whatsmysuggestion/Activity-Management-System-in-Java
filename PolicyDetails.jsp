...
<p align="right"><b>Agent ID : <%=ano%></b></p>
  <form action="PolicyDetails.jsp" method="post">
   <table border="0" cellpadding="0" cellspacing="0" style="border-bottom:1.5pt solid black; border-collapse: collapse; border-left-style:none; border-right-style:none; border-top-style:none; background-color:silver" bordercolor="#111111" width="496" id="AutoNumber1" fpstyle="9,011111000" height="26">
     <tr>
       <td style="font-weight: bold; color: white; border-left-style: none; border-right-style: none; border-top-style: none; border-bottom: 1.5pt solid black; background-color: maroon" align="center" height="1" width="496">
       <select size="1" name="cust">
       <option>Select Customer</option>
       <%
       	while(rsclist.next())
       	{
       		String str = rsclist.getString(1);
       %>
       		<option value="<%=str%>"><%= str + "    " + rsclist.getString(2) + " " + rsclist.getString(3)%></option>
		<%
		}
		%>
       </select> <input type="submit" value="View" name="B1"></td>
     </tr>
   </table>
   </form>
   <br>
  ...
  %>
   ...
   <table border="0" cellpadding="0" cellspacing="0" style="border-bottom:1.5pt solid black; border-collapse: collapse; border-left-style:none; border-right-style:none; border-top-style:none; background-color:silver" bordercolor="#111111" width="70%" id="AutoNumber2" fpstyle="9,011111000" height="133">
     ...
     <tr>
       ...
       <a href="AddPolicy.jsp?cno=<%=cno%>">Add Policy</a> | <a href="PayReport.jsp?cno=<%=cno%>">Payment
       Report</a></td>
     </tr>
     <%
     	}
